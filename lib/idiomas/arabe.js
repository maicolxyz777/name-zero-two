...
const smsUnreg = () => { return `\`\`\`¡¡يجب أن تكون مسجلاً اكتب (finalizar.) لاستخدام هذا الأوامر كامله للبوت!\`\`\`` }
...
const smsLista1 = () => { return `🌟 معلومات 𝐁𝐎𝐓 𝗟𝐎𝐒𝐄𝐅𝐀𝐑 🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت 𝐁𝐎𝐓 𝗟𝐎𝐒𝐄𝐅𝐀𝐑 🐈`}
const smsLista8 = () => { return `🍄 كن 𝐁𝐎𝐓 𝗟𝐎𝐒𝐄𝐅𝐀𝐑 🍄`}
...
const eGataCoins = () => { return '🐱 𝐁𝐎𝐓 𝗟𝐎𝐒𝐄𝐅𝐀𝐑' }
const eGataTickers = () => { return '🎫 𝐁𝐎𝐓 𝗟𝐎𝐒𝐄𝐅𝐀𝐑' } 
...
const smsContacto4 = () => { return 'جهة اتصال لبوت لوسيفار الرسمية 🐈'}

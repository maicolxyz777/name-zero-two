...
handler.command = ['تسجيل', 'verificar', 'register', 'registrar', 'reg', 'reg1', 'nombre', 'name', 'nombre2', 'name2', 'edad', 'age', 'edad2', 'age2', 'genero', 'género', 'gender', 'identidad', 'pasatiempo', 'hobby', 'identity', 'تسجيل', 'pas2', 'pas3', 'pas4', 'pas5']  ///^(تسجيل|تسجيل|reg(ister)?)$/i
